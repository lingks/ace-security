...
function initSearchmenu(searchform, cloudSearchUrl) {
	var defaultUrl = 'http://www.bitett.com/static/js/search.php?searchsubmit=yes';
...
function pluginNotice() {
	if($('plugin_notice')) {
		ajaxget('http://www.bitett.com/static/js/misc.php?mod=patch&action=pluginnotice', 'plugin_notice', '');
	}
}
